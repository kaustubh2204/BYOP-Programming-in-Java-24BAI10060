...
tasks.dat: The binary data file where your tasks are stored (generated after first save).

How to Run
Ensure JDK is installed: You need Java 8 or higher.

Download the files: Clone this repository or download Task.java and TaskMang.java.
